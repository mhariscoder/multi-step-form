    ...
    <header className="w-full bg-[#f5f2ed] border-b border-black/5">
      <div className="mx-auto flex h-[92px] max-w-[1920px] items-center justify-between px-8 xl:px-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="heading-font text-[24px] font-normal tracking-[-0.02em] text-[#1a1a1a] sm:text-[22px] md:text-[24px]">
            Shop Modern Blinds
          </h1>
        </div>

        <nav className="hidden items-center text-font gap-10 lg:flex">
          <a
            href="#"
